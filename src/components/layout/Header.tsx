...
const NAV_LINKS = [
  { href: "/", label: "Home" },
  { href: "/tiktok-story-viewer", label: "Story" },
  { href: "/tiktok-highlights-viewer", label: "Highlights" },
  { href: "/tiktok-reposts-viewer", label: "Repost" },
  { href: "/tiktok-live-downloader", label: "Live" },
  { href: "/tiktok-age-checker", label: "Age" },
  // Blog slot reserved — not yet built
];
